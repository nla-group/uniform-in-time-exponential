% This codes creates the first subplot in Figure 4.
...
t = logspace(-1, 0, 11);   % time
C1 = 1.70;                 % optimal linear factor for concentrated real poles
...
conc_poles = -C1*n*ones(1,n); % optimal concentrated real poles
xistart = inf(1,n);
...
title('$T = [10^{-1}, 1]$', 'Interpreter','latex','FontWeight','normal','FontSize',18);
