% This codes creates the second subplot in Figure 4.
...
%% Time ratio tmax/tmin = 10^2
t = logspace(-2, 0, 21);   % time
C2 = 2.67;                 % optimal linear factor for concentrated real poles
...
conc_poles = -C2*n*ones(1,n); % optimal concentrated real poles
xistart = inf(1,n);
...
title('$T = [10^{-2}, 1]$', 'Interpreter','latex','FontWeight','normal','FontSize',18);
