% This codes creates the fourth subplot in Figure 4.
...
conc_poles = -C4*n*ones(1,n); % optimal concentrated real poles
xistart = inf(1,n);
...
title('$T = [10^{-4}, 1]$', 'Interpreter','latex','FontWeight','normal','FontSize',18);
